...
public class Main
{
	...
	private static PathWrapper getBestPath(GraphHopper hopper, double LAT_FROM, double LON_FROM, double LAT_TO, double LON_TO)
	{
		...
		GHRequest req = new GHRequest(LAT_FROM, LON_FROM, LAT_TO, LON_TO).setWeighting("fastest").setVehicle("car")
	...
	//	Translation transl = new TranslationMap.TranslationHashMap(Locale.getDefault());

		// iterate over every turn instruction
		System.out.println("Start at: " + startEdge.getName());
		for (Instruction instruction : il)
		{
			System.out.print(">> " + getInstructionMessage(instruction) + " ");
